      ...
      <View style={[styles.card, styles.elevated]}>
        ...
        <View style={styles.cardBody}>
          <Text numberOfLines={3}>
            ...
            libero. Recusandae provident cum tempora consequuntur minima
            possimus excepturi dolores explicabo illo eveniet quibusdam
            reiciendis cupiditate, iusto ad architecto sunt minus? Eveniet dolor
            eligendi provident quia est nostrum ab, quas ipsum corporis fugiat
            dolore debitis, aperiam non, ducimus tenetur sed quisquam obcaecati.
            Natus pariatur facere ut atque labore delectus iure suscipit!
            Delectus minus tempora quo praesentium architecto neque, culpa
            nesciunt expedita modi, molestiae quaerat voluptatem a! Rem, omnis
            corporis, quae temporibus laboriosam consequatur ipsa, cum ea quam
            et harum necessitatibus in!
          </Text>
        </View>
